...
namespace Document_Service.Services
{
    public class Scan
    {
        ...
        public async Task<IActionResult> UploadScanFile(string userId, string document_type, IFormFile file)
        {
        ...
        public async Task<IActionResult> GetScanFile(string userId, string document_type)
        {
        ...
        public async Task<IActionResult> DeleteScanFile(string userId, string document_type)
        {
            if (document_type == "passport")
            {
                PassportDocument passportDocument = await _context.Passports.Where(p => p.id == userId).FirstOrDefaultAsync();
